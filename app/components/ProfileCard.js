        ...
        <div className='flex grow flex-col items-center justify-center space-y-2'>
            {!profileAdded ? (
                ...
                <div className='flex w-full grow flex-col'>
                    ...
                    <div className='my-6 grid grow grid-cols-2 items-center gap-x-10 px-5'>
            ...
            <dialog id='profileDetailsModal' className={`modal ${isModalOpen ? 'modal-open' : ''}`}>
                <div className='modal-box p-0'>
                            ...
                            {!profileFormPage ? (
                                ...
                                >
                                    ...
                                    <div className='flex flex-row-reverse'>
                                        <button
                                            className='btn rounded-xl bg-[#3E84F8] text-[14px] text-white hover:bg-[#3E84F8]'
                    ...
                    <button
                        className='btn btn-circle btn-ghost btn-sm absolute right-5 top-3 outline-none'
